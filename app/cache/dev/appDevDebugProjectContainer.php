...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'comparateuragricole', 'user' => 'root', 'password' => 'jecode4laloupe', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/ComparateurBundle/Resources/config/doctrine') => 'ComparateurBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'ComparateurBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ComparateurBundle' => 'ComparateurBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_846fed01729a6424392364e06580305e2e5e8f7e6babe1c285a7f315d3988ce3');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ComparateurBundle/Resources/views'), 'Comparateur');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('aad1b1e3c4a6c7652969febbca1357adfb9022d9');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57f6645859c5a9.73243549')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ComparateurBundle' => 'ComparateurBundle\\ComparateurBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'comparateuragricole',
            'database_user' => 'root',
            ...
            'secret' => 'aad1b1e3c4a6c7652969febbca1357adfb9022d9',
            'locale' => 'en',
            ...
            'kernel.secret' => 'aad1b1e3c4a6c7652969febbca1357adfb9022d9',
